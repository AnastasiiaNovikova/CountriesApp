# This project allows to see countries, returned by  [Countries API](https://restcountries.com/v3.1/all) and their properties, and to add countries to favorite. 

## Featues:
- Add to favorite.
- Filter / search by name, language, currency.
